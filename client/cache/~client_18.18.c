...
void deleteUser(GtkButton *btn, gpointer data) {
    ...
    GtkWidget *deltarget = gtk_grid_get_child_at(adm_user, 0, GPOINTER_TO_INT(data));
    gtk_label_set_text(deltarget, "(deleted)");

    GtkWidget *deltarget = gtk_grid_get_child_at(adm_user, 1, GPOINTER_TO_INT(data));
    gtk_label_set_text(deltarget, "(deleted)");

    GtkWidget *deltarget = gtk_grid_get_child_at(adm_user, 2, GPOINTER_TO_INT(data));
    gtk_label_set_text(deltarget, "(deleted)");

    GtkWidget *deltarget = gtk_grid_get_child_at(adm_user, 3, GPOINTER_TO_INT(data));
    gtk_label_set_text(deltarget, "(deleted)");

    GtkWidget *deltarget = gtk_grid_get_child_at(adm_user, 4, GPOINTER_TO_INT(data));
    gtk_label_set_text(deltarget, "(deleted)");
    
    GtkWidget *deltarget = gtk_grid_get_child_at(adm_user, 5, GPOINTER_TO_INT(data));
    gtk_label_set_text(deltarget, "(deleted)");
