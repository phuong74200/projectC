...
int adm_getProductList() {
    if (getproducts_end == 1) {
        ...
        gtk_color_button_set_color(colorBtn3, &color1);

        gtk_grid_attach(colorPick, colorBtn1, 0, 0, 1, 1);
        gtk_grid_attach(colorPick, colorBtn1, 1, 0, 1, 1);
        gtk_grid_attach(colorPick, colorBtn1, 2, 0, 1, 1);
