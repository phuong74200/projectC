...
int adm_getProductList() {
    if (getproducts_end == 1) {
        ...
        slot = gtk_label_new(xmlp("sale", XMLBuffer));
        ...
        gdk_color_parse(&color1, xmlp("color1", XMLBuffer));
        GtkWidget *colorBtn1;
        colorBtn1 = gtk_color_button_new_with_color(&color1);
        gtk_grid_attach(colorPick, colorBtn, 0, 0, 1, 1);

        gdk_color_parse(&color1, xmlp("color2", XMLBuffer));
        GtkWidget *colorBtn2;
        colorBtn2 = gtk_color_button_new_with_color(&color1);
        gtk_grid_attach(colorPick, colorBtn, 1, 0, 1, 1);

        gdk_color_parse(&color1, xmlp("color3", XMLBuffer));
        GtkWidget *colorBtn3;
        colorBtn = gtk_color_button_new_with_color(&color1);
        gtk_grid_attach(colorPick, colorBtn, 2, 0, 1, 1);
