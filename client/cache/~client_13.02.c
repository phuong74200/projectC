...
int adm_getProductList() {
    if (getproducts_end == 1) {
        ...
        printf("--color1 : %s\n", xmlp("color1", XMLBuffer));

        gdk_rgba_parse(&color2, xmlp("color2", XMLBuffer));
        GtkWidget *colorBtn2;
        colorBtn2 = gtk_color_button_new_with_color(&color2);
        gtk_grid_attach(colorPick, colorBtn2, 1, 0, 1, 1);

        printf("--color2 : %s\n", xmlp("color2", XMLBuffer));

        gdk_rgba_parse(&color3, xmlp("color3", XMLBuffer));
        GtkWidget *colorBtn3;
        colorBtn3 = gtk_color_button_new_with_color(&color3);
        gtk_grid_attach(colorPick, colorBtn3, 2, 0, 1, 1);
        gtk_color_button_set_color(colorBtn3, &color3);

        printf("--color3 : %s\n", xmlp("color3", XMLBuffer));
