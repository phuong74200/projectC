...
void xmlp(char tagName[100], char xmlstr[1000], int *ret) {
    char openTag[100] = "";
    char closeTag[100] = "";
    ...
    int spoint = xmlstr + openTagPos + strlen(openTag);
    int epoint = clpos - oppos - strlen(closeTag) + 1;

    memcpy(ret, spoint, epoint);
