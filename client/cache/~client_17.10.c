...
char *addZero(char str[100], int leadZeros) {
    static char hexaDeciNum[100] = "";
    ...
    for (int i = strlen(str); i < leadZeros; i++) {
        strcat(hexaDeciNum, "0");
    }

    strcat(hexaDeciNum, str);
...
int addItemThread(gpointer data) {
    ...
    strcat(clstr, addZero(decToHexa((int)(color1->red * 255)), 2));
    strcat(clstr, addZero(decToHexa((int)(color1->green * 255)), 2));
    strcat(clstr, addZero(decToHexa((int)(color1->blue * 255)), 2));
    strcat(clstr, "</color1>");
    ...
    printf("%d, %d, %d\n", (int)(color1->red * 255), (int)(color1->green * 255), (int)(color1->blue * 255));
...
int addProductsThread(gpointer top) {
    ...
    if (strcmp(response, "none") != 0) {
        ...
        strcpy(rgb, "rgb(");
        strcat(rgb, xmlp("color1", response));
        strcat(rgb, ")");
        printf("\n%s\n", rgb);
        ...
        strcpy(rgb, "rgb(");
        strcat(rgb, xmlp("color2", response));
        strcat(rgb, ")");
        gdk_color_parse(rgb, &color);
        gtk_widget_modify_bg(GTK_WIDGET(obj), GTK_STATE_NORMAL, &color);
        ...
        strcpy(rgb, "rgb(");
        strcat(rgb, xmlp("color3", response));
        strcat(rgb, ")");
        gdk_color_parse(rgb, &color);
        gtk_widget_modify_bg(GTK_WIDGET(obj), GTK_STATE_NORMAL, &color);
