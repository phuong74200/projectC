...
void entrychecking1() {
    ...
    printf("%c | %c", password[0], username[0]);
...
void loginScreenDisplay() {
    ...
    g_signal_connect(passwordEntry, "delete-text", G_CALLBACK(entrychecking1), NULL);
    g_signal_connect(usernameEntry, "insert-text", G_CALLBACK(entrychecking2), NULL);
}
