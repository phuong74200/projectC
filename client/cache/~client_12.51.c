...
int adm_getProductList() {
    if (getproducts_end == 1) {
        ...
        gdk_rgba_parse(&color1, xmlp("color1", XMLBuffer));
        colorBtn = gtk_color_button_new_with_color(&color1);
        gtk_grid_attach(colorPick, colorBtn, 0, 0, 1, 1);

        gdk_rgba_parse(&color1, xmlp("color2", XMLBuffer));
        colorBtn = gtk_color_button_new_with_color(&color1);
        gtk_grid_attach(colorPick, colorBtn, 0, 1, 1, 1);

        gdk_rgba_parse(&color1, xmlp("color3", XMLBuffer));
        colorBtn = gtk_color_button_new_with_color(&color1);
        gtk_grid_attach(colorPick, colorBtn, 0, 2, 1, 1);
