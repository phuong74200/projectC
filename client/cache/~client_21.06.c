...
void entrychecking1(GtkEntry *entry, gpointer user_data) {
    ...
    gchar *password = gtk_entry_get_text(passwordEntry);
    gchar *username = gtk_entry_get_text(usernameEntry);
...
void loginScreenDisplay() {
    ...
    g_signal_connect(usernameEntry, "activate", G_CALLBACK(entrychecking1), NULL);
}
