...
void guestLogin() {
    GObject *landingPage = gtk_builder_get_object(builder, "landingPage");

    GObject *loginForm = gtk_builder_get_object(builder, "loginForm");
    gtk_widget_destroy(loginForm);
    GObject *registerForm = gtk_builder_get_object(builder, "registerForm");
    gtk_widget_destroy(registerForm);
